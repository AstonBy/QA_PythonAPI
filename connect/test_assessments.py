...
class TestAssessments(BaseCase):
    def test_happiness_assessment(self):
        ...
        while True:
            ...
            Assertions.assert_status_code(response_answers_ha, 200)
        ...
        # assert "You're Getting There" not in self.get_json_value(response_home, "happiness_scores")[0]['description']
        # print(happiness_scores_homepage)
