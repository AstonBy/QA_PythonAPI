...
print(result_json["happiness_scores"])
print(f'HA_Score is {result_json["happiness_scores"][0]["score"]}')
# ha_score_json_value = result_json["happiness_scores"]
# print(ha_score_json_value[])
